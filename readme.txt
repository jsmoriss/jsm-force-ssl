...
Other plugins use [PHP's output buffer](https://secure.php.net/manual/en/function.ob-start.php) to search &amp; replace URLs in the rendered webpage HTML, which is an error prone technique and negatively affects caching performance.
