...
<p><strong>An effective way to make sure that all HTTP URLs on your website get redirected to HTTPS, including upload directory URLs for images, etc.</strong></p>
