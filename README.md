...
<p><strong>SIGNIFICANTLY DIFFERENT than other plugins of this type</strong> (<em>in the very best way</em>):</p>
...
<p><strong>Honors proxy / load-balancing variables for advanced / large web sites:</strong></p>
