<h1>JSM&#039;s Force HTTP to HTTPS (SSL)</h1><h3>Simple, Safe, and Best for SEO</h3>
...
<p>No setup required! Simply activate the plugin to force HTTP URLs to HTTPS using native WordPress filters and 301 permanent redirects for best SEO.</p>
...
<p>This plugin uses native WordPress filters for maximum caching compatibility and performance, with 301 permanent redirects (<a href="https://en.wikipedia.org/wiki/HTTP_301">which are considered best for SEO when moving from HTTP to HTTPS</a>).</p>
