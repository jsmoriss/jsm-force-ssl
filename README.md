...
<tr><th align="right" valign="top" nowrap>Summary</th><td>Safe, amazingly fast, simple and effective &mdash; force HTTP URLs to HTTPS using WordPress filters and permanent redirects.</td></tr>
...
<p><strong>A safe, amazingly fast, simple and effective way to make sure that all HTTP URLs get rewritten / redirected to HTTPS, including the WordPress upload folder and plugin url paths.</strong></p>
