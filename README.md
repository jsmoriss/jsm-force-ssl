...
<tr><th align="right" valign="top" nowrap>Summary</th><td>Simple, fast and effective - no setup required. Force HTTP URLs to HTTPS using WordPress filters for speed and reliability.</td></tr>
