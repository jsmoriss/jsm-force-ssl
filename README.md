<h1>JSM&#039;s Force HTTP to HTTPS (SSL) - Simple, Safe, Reliable, and Fast!</h1>
...
<ul>
<li>X-Forwarded-Proto (aka 'HTTP_X_FORWARDED_PROTO')</li>
<li>X-Forwarded-Ssl (aka 'HTTP_X_FORWARDED_SSL')</li>
</ul>

<p>See <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Forwarded-Proto">Web technology for developers &gt; HTTP &gt; HTTP headers &gt; X-Forwarded-Proto</a>.</p>
