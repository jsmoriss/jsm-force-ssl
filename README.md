...
<p>The plugin defines the <code>FORCE_SSL</code>, <code>FORCE_SSL_ADMIN</code>, and <code>FORCE_SSL_LOGIN</code> constants (if not already defined), then makes sure that all front-end HTTP requests are redirected to their HTTPS equivalent.</p>
