...
<p>Other plugins use <a href="https://secure.php.net/manual/en/function.ob-start.php">PHP's output buffer</a> to search &amp; replace URLs in the webpage HTML, which is error prone and negatively affects caching plugin performance.</p>
